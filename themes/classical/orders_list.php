...
<body>
    <h1 class="title front-color">兑换订单明细</h1>
    <?php
        require_once(LIBRARIES_PATH."/CreateList.php");
        $CreateList_object = new CreateList($this->fields,$this->result_data,$this->result_page_info,$this->advanced_search_fields,array("single_delete"=>false,"multiple_delete"=>false,"excel"=>true,"custom"=>array()));
    ?>
    <div class="tab_page">
        <div class="search"><span class="order">排序：<?php echo $CreateList_object->c_order(); ?></span><span class="search_form"><?php echo $CreateList_object->c_search(); ?><a id="advanced_search_form_open" onclick="open_advanced_search()" class="advanced_search_open">高级搜索</a></span><?php echo $CreateList_object->c_advanced_search(); ?></div>
        <div class="clear"></div>
