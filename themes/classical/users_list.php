...
<body>
    <h1 class="title front-color">用户管理</h1>
    <?php
    ...
    ?>
    <div class="tab_page">
        <div class="search"><span class="order"><a href="javascript:add('1024','512','新增用户');">新增用户</a>排序：<?php echo $CreateList_object->c_order(); ?></span><span class="search_form"><?php echo $CreateList_object->c_search(); ?><a id="advanced_search_form_open" onclick="open_advanced_search()" class="advanced_search_open">高级搜索</a></span><?php echo $CreateList_object->c_advanced_search(); ?></div>
        <div class="clear"></div>
