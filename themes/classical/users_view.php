...
<head>
    ...
    <script type="text/javascript">
        if(window.parent.WindowObject){
            window.parent.WindowObject.size("800px","520px");
            window.parent.WindowObject.title("编辑用户信息");
        }
    </script>
</head>
<body>
    <?php
        ...
        $CreateForm_object = new CreateForm($this->form_fields,$this->result_data,array(array("value"=>"保存","onclick"=>"users_update()")),$this->form_list_fields,$this->form_list_result_data);
    ?>
    <script type="text/javascript">
