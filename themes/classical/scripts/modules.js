...
function add(width,height,title){
    //var width = arguments[0] ? arguments[0] : "1024px";
    //var height = arguments[1] ? arguments[1] : "500px";
    window.parent.GoToWindowPage(width+"px",height+"px",title,window.location.href.replace(/\?.*$/ig,"")+"?controller="+url_get("controller")+"&action=add&backURL="+escape(url_get("backURL")?url_get("backURL"):window.location.href));
    
}
function view(id,width,height,title){
    if(id){
        window.parent.GoToWindowPage(width+"px",height+"px",title,window.location.href.replace(/\?.*$/ig,"")+"?controller="+url_get("controller")+"&action=view&id="+id+"&backURL="+escape(window.location.href));
    }
}
