...
<body>
    <?php
        ...
        $CreateForm_object = new CreateForm($this->form_fields,$this->result_data,array(array("value"=>"保存","onclick"=>"users_add()")),$this->form_list_fields,$this->form_list_result_data);
    ?>
