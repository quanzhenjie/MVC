...
$(document).ready(function(){
    ...
    var input_function = {
        pwd_focus : function(){
            $("#pwd").focus(function(){
                $(this).remove();
                $("#user").after('<input type="password" id="pwd" name="pwd" class="pwd_input" title="请输入密码" />');
                $("#pwd").focus();$("#pwd").focus();
                $("#pwd").blur(function(){
                    if($("#pwd").val().length<1 || !/^[\w]+?$/.exec($("#pwd").val())){
                        $(this).remove();
                        $("#user").after('<input type="text" id="pwd" name="pwd" class="pwd_input" title="请输入密码" />');
