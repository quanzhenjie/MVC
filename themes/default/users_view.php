...
<body>
    <?php
        ...
        $CreateForm_object = new CreateForm($this->form_fields,$this->result_data,array(array("value"=>"保存","onclick"=>"users_update()"),array("value"=>"返回新增","onclick"=>"add()"),array("value"=>"删除","onclick"=>"single_delete(url_get('id'))"),array("value"=>"返回列表","onclick"=>"back_list()")),$this->form_list_fields,$this->form_list_result_data);
    ?>
    <script type="text/javascript">
        function users_update(){
            ...
            ?>
            $.post("index.php?controller="+url_get("controller")+"&action=update",{<?php echo $CreateForm_object->c_post_send(); ?>},function(back_data){
