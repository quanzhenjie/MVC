...
<body>
    ...
    ?>
    <div class="tab_page">
        <div class="search"><span class="order">排序：<?php echo $CreateList_object->c_order(); ?><a href="javascript:add();">新增用户</a></span><span class="search_form"><?php echo $CreateList_object->c_search(); ?><a id="advanced_search_form_open" href="javascript:open_advanced_search();" class="advanced_search_open">高级搜索</a></span><?php echo $CreateList_object->c_advanced_search(); ?></div>
        <div class="clear"></div>
